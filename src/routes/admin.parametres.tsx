        ...
        >
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-2">
              Montant versé à l'agent pour chaque fiche qu'il marque comme terminée. Modifiable à
              tout moment — les commissions déjà attribuées ne bougent pas.
            </p>
            <div className="flex items-center gap-2">
              <input
                ...
                className="rounded-lg border border-border bg-background px-3 py-2 w-32 text-right font-semibold"
              />
          ...
          <button
            disabled={saving}
            className="rounded-full bg-google-blue text-white font-semibold px-5 py-2 disabled:opacity-50"
          >
